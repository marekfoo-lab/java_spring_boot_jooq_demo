...
* The original package name 'pl.mfconsulting.java.demo.spring-jooq.spring-jooq' is invalid and this project uses 'pl.mfconsulting.java.demo.spring_jooq.quarkus_jooq' instead.
